# 8 bit standard used: | sign (1) | exponent (4) | fraction (3) |
import math
...
# def to_ieee754_float16(x):
    ...
    if x==0:
        ...
        if exp >= 15:
            return f"{sign}1111" + "0"*(MAN_BITS)   # overflow → infinity

        exponent_bits = format(exp, "04b")
...
#add 2 ieee754 numbers
    ...
    return f"{sign}{format(exp,'04b')}{format(mant,'03b')}"
...
def mul_ieee(a, b):
    ...
    return str(sign) + format(exp, "04b") + format(frac, "03b")
