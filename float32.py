# 8 bit standard used: | sign (1) | exponent (8) | fraction (23) |
import math
...
#add 2 ieee754 numbers
    ...
    return f"{sign}{format(exp,'08b')}{format(mant,'023b')}"
...
def mul_ieee(a, b):
    ...
    return str(sign) + format(exp, "08b") + format(frac, "23b")
